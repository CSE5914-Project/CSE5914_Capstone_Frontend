...
export default class ProfilePage extends React.Component {
  ...
  componentDidMount() {
    fetch(
      `https://api.themoviedb.org/3/movie/${this.props.match.params.id}?api_key=d555832ef92f1a8c0c212f671e1f0c9a&language=en-US`
    )
      .then((res) => res.json())
      .then((movie) => {
        this.setState({
              ...
              <div style={{ float: "left", marginTop: 50 }}>
                ...
                <p style={{ textAlign: "left" }}>
                  <p>
                    ...
                    <b>Original Language:</b> {this.state.original_language}{" "}
                    <br />
